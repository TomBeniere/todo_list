    ...
    <main class="text-gray-800">
       <section class="md:w-2/3 lg:w-1/3 mx-auto mt-4">
            ...
            <table class="w-full mt-2">
                ...
                <tr class="border-t-2">
                    <td class="px-4 todo-item p-2"><?php echo "Une chose a faire";?></td>
                    <td class="hidden todo-input p-2">
                        <form action="traitement.php" method="post" class="text-center">
                            <input type="text" name="update" class="border p-2 rounded" value="<?php echo "Une chose a faire";?>">
                            <input type="hidden" name="id" value="<?php "1";?>">
                    ...
                    <td class="todo-actions text-center p-2 flex justify-center">
                        ...
                        <form action="traitement.php" method="post">
                            <input type="hidden" name="delete" value="<?php echo "Une chose a faire";?>">
